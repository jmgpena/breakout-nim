...
type
  ...
  Input {.pure.} = enum none, left, right, restart, quit
...
proc main =
  ...
  # defer blocks get called at the end of the procedure, even if an exception has been thrown
  defer: sdl2.quit()

  sdlFailIf(not setHint("SDL_RENDER_SCALE_QUALITY", "2")):
    "Linear texture filtering could not be enabled"

  let window = createWindow(title = "Breakout", x = SDL_WINDOWPOS_CENTERED, y = SDL_WINDOWPOS_CENTERED,
  ...
  renderer.setDrawColor(r = 120, g = 132, b = 174)
